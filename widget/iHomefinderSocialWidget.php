...
if( !class_exists('iHomefinderSocialWidget')) {
	...
	class iHomefinderSocialWidget extends WP_Widget {
	    ...
	    function widget($args, $instance) {
			...
			if($facebookUrl) {
	       		echo '<a href="' . $facebookUrl . '"><img src="' . $baseUrl . '/images/fbicon.png" width="24" height="24" style="width:24px;" /></a> ';
			}
			if($twitterUrl) {
    	   		echo '<a href="' . $twitterUrl. '"><img src="' . $baseUrl . '/images/twittericon.png" width="24" height="24" style="width:24px;" /></a> ';
			}
			if($linkedinUrl) {
