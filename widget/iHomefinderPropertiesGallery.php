...
class iHomefinderPropertiesGallery extends WP_Widget {
	...
	private $widgetType = iHomefinderWidgetUtility::GALLERY_WIDGET_TYPE;
	...
	public function form($instance) {
		...
		$hotsheets = $formData->getHotsheetList();
		$cities = $formData->getCitiesList();
		$propertyTypes = $formData->getPropertyTypesList();
		?>
		<p class="galleryType">
		...
		<div class="pageSelector" style="display: none;">
			<?php echo $this->widgetUtility->getPageSelector($this, $instance, $this->widgetType); ?>
			<br />
		</div>
