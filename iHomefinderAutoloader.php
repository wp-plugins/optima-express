...
class iHomefinderAutoloader {
	...
	private $classes = array(
			...
			"iHomefinderShortcodeSelectorContent" => "iHomefinderShortcodeSelectorContent.php",
			...
			"iHomefinderTinyMceManager" => "iHomefinderTinyMceManager.php",
			...
			"iHomefinderVirtualPageHelper" => "iHomefinderVirtualPageHelper.php",
			"iHomefinderLayoutManager" => "iHomefinderLayoutManager.php",
			"iHomefinderCacheUtility" => "iHomefinderCacheUtility.php",
			//widgets
			"iHomefinderWidgetContextUtility" => "widget/iHomefinderWidgetContextUtility.php",
			...
			"iHomefinderSearchByAddressResultsVirtualPageImpl" => "virtualPage/iHomefinderSearchByAddressResultsVirtualPageImpl.php",
			"iHomefinderSearchByListingIdResultsVirtualPageImpl" => "virtualPage/iHomefinderSearchByListingIdResultsVirtualPageImpl.php",
