...
class iHomefinderVariableUtility {
	...
	public function getSavedSearchId() {
		return new iHomefinderVariable("savedSearchId", null, "Saved Search ID");
	}
	
	public function getSavedSearchName() {
		return new iHomefinderVariable("savedSearchName", null, "Saved Search Name" );
	}
	
	public function getSavedSearchDescription() {
		return new iHomefinderVariable("savedSearchDescription", null, "Saved Search Description");
	}
